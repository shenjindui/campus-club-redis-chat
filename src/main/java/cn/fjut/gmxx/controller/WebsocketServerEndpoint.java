...
import cn.fjut.gmxx.exception.ExceptionFactory;
...
import cn.fjut.gmxx.utils.CoreUtil;
import cn.fjut.gmxx.utils.GetHttpSessionConfigurator;
...
public class WebsocketServerEndpoint {
    ...
    public void onOpen(Session session, @PathParam("id") String id) {
        ...
        try {
            ...
            throw ExceptionFactory.getBizException(e.getMessage());
        }
    }
    ...
    public void sendTo(String toId, Message entity) {
        ...
        if (websocketServerEndpoints.size() <=1) {
            ...
            throw ExceptionFactory.getBizException("用户未上线");
        }
        boolean flag = false;
        ...
        if (!flag) {
            throw ExceptionFactory.getBizException("推送失败，找不到该窗口");
